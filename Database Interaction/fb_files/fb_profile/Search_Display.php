...
?>
			...
			<td width="500" bgcolor="#FFFFFF" id="Name_bg<?php echo $uid;?>"> <a href="Profile.php" style=" text-decoration:none; text-transform:capitalize; color:#8a0c2a;" id="Name_font<?php echo $uid;?>">  <?php echo $name; ?> (Me)</a></td>
...
?>
			...
			<td width="500" bgcolor="#FFFFFF" id="Name_bg<?php echo $uid;?>"> <a href="../fb_view_profile/view_profile.php?id=<?php echo $uid; ?>" style=" text-decoration:none; text-transform:capitalize; color:#8a0c2a;" id="Name_font<?php echo $uid;?>">  <F?php echo $name; ?>  </a></td>
...
?>
		<tr>
			...
			<td height="50" colspan="2" bgcolor="#F2F2F2" onMouseOver="see_more_over()" onMouseOut="see_more_out()" id="see_more"><a id="see_more_text" href="../fb_home/Search_Display_submit.php?search1=<?php echo $id; ?>" style="text-decoration:none; color:#8a0c2a;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; See more results &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
		</tr>
		</table>
		</div>
<?php
