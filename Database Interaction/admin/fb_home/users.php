...
?>
    	<tr>
            ...
            <td style="padding-left:13; padding-top:8;"> <form method="post"> 
            	...
            	<input type="submit" name="mdelete" value="delete User" style="background-color:#FFFFFF; border:#FFFFFF;  "> 
                 </form> 
            </td>
        </tr>
<?php
...
?>
    	<tr>
            ...
            <td style="padding-left:13; padding-top:8;"> <form method="post"> 
            	 ...
            	 <input type="submit" name="fdelete" value="delete user" style="background-color:#FFFFFF; border:#FFFFFF;  ">  
                 </form> 
            </td>
        </tr>
<?php
