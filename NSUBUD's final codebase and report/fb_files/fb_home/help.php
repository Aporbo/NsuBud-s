<?php
	...
	if(isset($_SESSION['fbuser']))
	{
		...
		if(isset($_POST['help']))
		{
			...
			mysqli_query($con,"insert into help(user_id,help_txt,type,Date) values($userid,'$fb_txt','$type','$fb_time')");
		}
...
; position:absolute; left:25%; top:32%; height:24%; width:41.4%; z-index:-1; box-shadow:0px 2px 10px 1px rgb(0,0,0);"> </div>
    ...
    <div style="position:absolute; left:30%; top:50.5%;">
    	<select name="type" style=" font-size:16px; height:25; width:90;"> 
...
?>
    ...
    <tr>
		<td colspan="2" style=" padding-left:15; "><?php echo $fb_txt; ?></td>
        <td> </td>
        <td> </td>
	</tr>
    <tr>
