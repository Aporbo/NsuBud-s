...
<?php
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Post/<?php echo $post_img; ?>" width="600"= height="320"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
...
?>
	<tr>
		<td> </td>
		<td width="4%" bgcolor="" style="padding-left:12; padding-right:42;" rowspan="2">  <img src="../../fb_users/<?php echo $user_gender1; ?>/<?php echo $user_Email1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">    </td>
