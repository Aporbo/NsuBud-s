...
">   </div>
<!--Head fb text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:3;"> <a href="../fb_home/Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_fb_text()" onMouseOut="out_head_fb_text()"> <font face="myFbFont"> NSUBUD's </font> </a> </div>
...
<div style="position:fixed; left:60.7%; top:1.6%; z-index:2;"> <a href="../fb_home/Group_Message.php"> <img style="height:28px" src="background_file/background_icons/messages.jpg"> </a> </div>
...
<?php 
	...
	$count_bg=$count_bg+1;
?>
<div style="position:absolute; left:15.11%; top:6%;"> <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" height="300" width="900" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
