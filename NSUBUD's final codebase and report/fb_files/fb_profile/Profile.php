...
<div style="position:absolute;left:44.7%; top:54%; font-weight:bold; z-index:1; color:#b01937;"> <a href="photos.php" style="text-decoration:none; color:#b01937;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>
...
<?php 
	...
	<tr>
		<td>   </td>
		<td  bgcolor="" style="width:2;" colspan="2"><img src="img/like.PNG"><span style="color:#8f305c;"><?php echo $count_like; ?></span> like this. </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
