...
<div style="position:absolute;left:44.7%; top:54%; font-weight:bold; z-index:1; color:#e1465d;"> <a href="photos.php" style="text-decoration:none; color:#e1465d;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:60%;top:101%; color:#80062d; font-weight:bold;"> Current Living Area </div>
<?php
	}	
?>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:59%;top:169%; color:#80062d; font-weight:bold;"> <?php echo $web; ?> </div>
<?php
	}
	else
	{
...
<?php
	...
	{
?>
		<div style="position:absolute;left:61%;top:175%; color:#80062d; font-weight:bold;"> <?php echo $fb_id; ?> </div>
