...
<body>
	...
	<div style="position:absolute; left:25%; top:18%; color:#8a0c2a; font-size:24px;"> Name </div>
    <div style="position:absolute; left:32%; top:18%; color:#909DB2; font-size:24px; text-transform:capitalize;">   </div>
    ...
    <div style="position:absolute; left:25%; top:35%; color:#8a0c2a; font-size:24px;"> Paasword </div>
    ...
    <div style="position:absolute; left:25%; top:47%; "> <input type="button" value="Deactivate your account." style="background:#FFF; color:#8a0c2a; font-size:15px; border:none;" onClick="delete_account()"> </div>
...
<form method="post"  name="name_change"  onSubmit="return name_check();">
    ...
    <div style="position:fixed; left:41.5%; top:32.5%; z-index:4;"> <input type="text" name="fnm" value="" style="height:35; width:200; font-size:18px;" maxlength="15"> </div>
    <div style="position:fixed; left:35%; top:40%; z-index:4; font-size:18px;"> Last Name </div>
    <div style="position:fixed; left:41.5%; top:39.5%; z-index:4;"> <input type="text" name="lnm" value="" style="height:35; width:200; font-size:18px;" maxlength="15"> </div>
