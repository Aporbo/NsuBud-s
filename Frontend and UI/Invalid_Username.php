...
<div style="position:absolute;left:0;top:0; height:13%; width:100%; z-index:-1; background:#d91835">   </div>
<div style="position:absolute;left:13.5%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold;"> <font face="mynsubudFont">   NSUBUD's </font> </div>

<div style="position:absolute;left:13.6%; top:14.8%;"> <a href="index.php" style="text-decoration:none;"> <input type="button" style="background-color:#e21c6f" value="Sign Up" id="singup_button">    </a> </div>
...
<div style="position:absolute; left:27.4%; top:28.2%;">  <font size="4"> NSUBUD's Login </font>  </div>
...
<form  method="post">
	...
	<div style="position:absolute;left:43.5%;top:71.7%; ">  <input type="submit" style="background-color:#a85b9b" name="Login" value="Log In" id="login_button" />  </div>
	<div style="position:absolute;left:47.5%;top:71.7%; "> or </div>
	<div style="position:absolute;left:49%;top:71.7%; "> <a href="index.php" style="color:#a85b9c;text-decoration:none;"> Sign up for NSUBUD's </a> </div>
	<div style="position:absolute;left:43.5%; top:77.2%; font-size:12px;"> <a href='Forgot_Password.php' style="text-decoration:none; color:#a85b9b;" > Forgot your password? </a> </div>
