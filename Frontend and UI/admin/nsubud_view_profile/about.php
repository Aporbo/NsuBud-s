...
<div style="position:absolute;left:19%;top:97%;"> <img src="img/job.PNG"> </div>
		...
		<div style="position:absolute;left:26%;top:101%; color:#a85b9b; font-weight:bold; "> Add a job </div>
...
<div style="position:absolute;left:19%;top:115%;"> <img src="img/school.PNG"> </div>
		...
		<div style="position:absolute;left:26%;top:119%; color:#a85b9b; font-weight:bold;"> Add a school or college </div>
...
<div style="position:absolute;left:19%;top:94%;color:#a85b9b;"> Job </div>
...
<div style="position:absolute;left:19%;top:108%;color:#a85b9b;"> School or College </div>
...
<div style="position:absolute;left:53%;top:115%;"> <img src="img/hometown.PNG"> </div>
		...
		<div style="position:absolute;left:60%;top:119%; color:#a85b9b; font-weight:bold;"> Add your hometown </div>
...
<div style="position:absolute;left:53%;top:94%;color:#a85b9b;"> Current City </div>
...
<div style="position:absolute;left:53%;top:108%;color:#a85b9b;"> hometown </div>
...
<div style="position:absolute;left:19%; top:169%; font-size:18px; color:#89919C;">Relationship </div>
		...
		<div style="position:absolute;left:27%;top:169.5%; color:#a85b9b; font-weight:bold;"> Add Relationship </div>
...
<div style="position:absolute;left:53%;top:156%; font-size:18px; color:#89919C;"> NSU ID </div>
		...
		<div style="position:absolute;left:62%;top:156.4%; color:#a85b9b; font-weight:bold;"> Add Mobile Number </div>
...
<div style="position:absolute;left:58%;top:162%; font-size:18px;"> </div>
   <div style="position:absolute;left:53%; top:169%; font-size:18px; color:#89919C;">Website</div>
		...
		<div style="position:absolute;left:59%;top:169%; color:#a85b9b; font-weight:bold;"> Add Website </div>
...
<div style="position:absolute;left:53%; top:175%; font-size:18px; color:#89919C;">Facebook ID </div>
		...
		<div style="position:absolute;left:61%;top:175%; color:#a85b9b; font-weight:bold;"> Add Facebook ID </div>
