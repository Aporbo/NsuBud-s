...
<!--head background-->
	...
	<!--text: faceback -->
	<div style="position:absolute;left:36%; top:3.3%; font-size:45; font-weight:900; color:#2a245f; font-weight:bold; box-shadow:0px -10px 20px 1px rgb(0,0,0);"> <font face="mynsubudFont"> NSUBUD's Admin </font> </div>
	<!--body background-->
    ...
    <div style="position:absolute; left:10%; top:15%;"> <img src="img/logo.png" width="600" height="500"> </div> 
    ...
    <form action="../index.php">
    	<div style="position:absolute;left:62%;top:75%; "> <input type="submit" value="Go back to NSUBUD's" id="go_to_nsubud"> </div>
    </form>
