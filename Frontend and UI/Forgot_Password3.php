...
<div style="position:absolute; left:42%; top:47%;"> <h4> Secret Question 2 </h4> </div>
 <form action="Forgot_Password4.php"  method="post"> 
	...
	<div style="position:absolute; left:45%; top:63%;">  <input type="submit" style="background-color:#a85b9b" name="Next" value="Next" id="next"> </div>
</form>
